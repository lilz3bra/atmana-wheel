...
export async function DELETE(req: NextRequest) {
    ...
    if (!raffle || raffle === "" || !id || id === "") return NextResponse.json({ error: "Missing parameters" }, { status: 400 });
    ...
    await prisma.giveaways.update({ where: { twitchId: raffle, id: id }, data: { twitchId: "" } });
